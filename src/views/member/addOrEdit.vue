<template>
    <div class="flexC">
        <page-header title="会员" description="会员" no-margin />
                ...
                <Row v-if="mode === PAGE_MODE.DETAIL">
                    <Col span="3">
                        ...
                        <div class="margin-top-8">
                            <div>
                                等级：{{ myForm.levelName || "普通会员" }}
                            </div>
                            <div
                                class="font-small gray-color"
                                v-if="myForm.levelExpireDate"
                            >
                                过期时间：{{ myForm.levelExpireDate }}
                            </div>
                        </div>
                    </Col>
                    <Col span="5" class="top-info">
                    ...
                    <Col span="3">
                        <div>
                            积分：{{
                                myForm.points ? myForm.points.points : 0
                            }}
                            <a
                        ...
                        <div>
                            账号状态：{{ myForm.status | accountStatus
                            }}<span
                                class="notice-error margin-top-10"
                                v-if="myForm.status !== 1"
                            >
                                <span>
                                    {{ myForm.status | accountStatus
                                    }}{{ myForm.disableDays }}天（{{
                                        myForm.disableReason
                                    }}）
                                </span>
                            </span>
                        </div>
                        <div>虚拟会员：{{ myForm.isVirtual | yesOrNo}}</div>
                    </Col>
                </Row>
                <div>
...
import TagSelect from "@/views/member/components/tag-category-select";
import PointsModal from "@/views/member/components/member-points-records";
