      ...
      >
        ...
        >
          ...
          <!-- <Divider type="vertical" />
                    <a
                        type="text"
                        @click="onShowCommissionConfig(row)"
                        class="break-word"
                    >提成设置</a
                    >
                    <Divider type="vertical" />
                    <a
                        type="text"
                        @click="onShowServeAddrConfig(row)"
                        class="break-word"
                    >服务区设置</a
                    > -->
          <template>
            ...
            <a
              ...
              type="text"
              class="break-word"
              @click="onShowMatchmarkerStatus(row.code)"
            >封号</a>
            <a
              v-else
              type="text"
              class="break-word"
              @click="recoveryMatchmarkerAcc(row.code)"
            >解封</a>
          </template>
          <Divider type="vertical" />
          <a
          ...
          <a
            type="text"
            @click="onShowCommissionRecord(row.code)"
            class="break-word"
          >收入明细</a>
        </div>
      </Table>
