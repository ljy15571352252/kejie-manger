            ...
            >
              ...
              >
                <Input
                  ...
                  v-model.trim="registerJson.mobileCode"
              ...
              <FormItem prop="oldPassword">
                <Input
                  ...
                  type="password"
                  v-model="registerJson.oldPassword"
                  clearable
                  placeholder="旧密码，至少6位密码，区分大小写"
                />
              </FormItem>
              <FormItem prop="newPassword">
                <Input
                  prefix="ios-lock-outline"
                  type="password"
                  v-model="registerJson.newPassword"
                  clearable
...
import { forgetPasswordReset } from "@/api/user/user";
        ...
        register() {
            this.$refs["registerForm"].validate(async valid => {
                if (valid) {
                    ...
                    this.loading = true;
                    let [res] = await this.promiseResult(
                        forgetPasswordReset(fd)
                    );
                    this.loading = false;
                    if (res ) {
