...
<script>
import SearchOption from "./components/servicecard-order-search-filter";
import { getServiceCardOrderList } from "@/api/product/servicecard";
    ...
    methods: {
        ...
        async getDataList(page) {
            ...
            let {
                ...
                size,
                current
            } = await getServiceCardOrderList(searchQuery);
