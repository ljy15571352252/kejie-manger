...
<script>
import SearchOption from "./components/matchmarker-postal-search-filter";
import CheckModal from "@/components/check/index";
import {
    getMatchMarkerPostalApplyList,
    checkMatchMarkerPostalApply,
...
export default {
                    ...
                    render: (h, params) => {
                        return h("div", [
                            h("Avatar", {
                                ...
                                attrs: {
                                    src: params.row.matchMarker.headUrl,
                                },
                            }),
                            h(
                                "span",
                                ...
                                params.row.matchMarker.nickName
                            ),
                        ]);
                    },
                },
    ...
    methods: {
        ...
        async onCheckFinish(data) {
            ...
            let ok = await checkMatchMarkerPostalApply(json);
            if (ok == true) {
        ...
        async getDataList(page) {
            ...
            let {
                ...
                size,
                current,
            } = await getMatchMarkerPostalApplyList(searchQuery);
